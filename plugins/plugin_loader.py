...
from core.constants import EXTENSIONS_DIR, PLUGIN_MANIFEST, PROJECT_EXTENSIONS_DIR, ICONS_DIR
...
class PluginLoader(QObject):
    ...
    def get_ordered_plugins(self) -> Tuple[List[Tuple[str, PluginConfig]], List[Tuple[str, PluginConfig]]]:
    ...
    def create_plugin(self, name: str, description: str, icon: str, exec_cmd: str) -> str:
        """创建新插件，返回 plugin_id"""
